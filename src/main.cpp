...
int main()
{
    ...
    if (setup_res == sensor_node_system::ErrorCode::OK) {
        ...
        SensorNode(sensor_node_system::modules::led, sensor_node_system::modules::logger, sensor_node_system::modules::temperature, sensor_node_system::modules::network).main_loop();
    }
